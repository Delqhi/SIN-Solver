...
class VetoEngine:
    ...
    async def solve_text_captcha(self, image_base64: str) -> Dict[str, Any]:
        ...
        if mistral_result and qwen_result:
            if mistral_result.lower() == qwen_result.lower():
                ...
                logger.info(f"Disagreement: Mistral='{mistral_result}', Qwen='{qwen_result}'. Calling Kimi...")
    ...
    async def solve_with_browser(self, url: str, captcha_type: str = "auto", timeout: int = 60) -> Dict[str, Any]:
        """
