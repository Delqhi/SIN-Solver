...
async def test_skyvern():
    ...
    result = await client.analyze_image(img_b64, task="Identify any CAPTCHAs or verification checkboxes like Cloudflare Turnstile or 'I am human'. Return JSON with coordinates.")
