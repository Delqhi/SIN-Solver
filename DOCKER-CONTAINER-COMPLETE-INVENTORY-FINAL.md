# SIN-Solver Docker Container Inventory - FINAL
**Complete Reference:** All 24 Running Containers  
**Generated:** 2026-01-28 19:55 UTC  
...
| **ROOMS (UI)** | 6 | room-01-dashboard, room-05-generator, room-09.1-rocketchat, room-16-supabase, room-21-nocodb, room-24-hoppscotch |
| **STORAGE** | 1 | room-09.2-mongodb |
| **SOLVERS** | 2 | solver-1.1-captcha, solver-2.1-survey |
| **DELQHI** | 6 | room-12-db, room-12-api, room-12-realtime, room-12-rest, room-12-storage, room-12-studio |
| **TOTAL** | **24** | All Running |
...
### 15. room-24-hoppscotch
| Attribut | Details |
|----------|---------|
| **Kategorie** | ROOMS (API Testing) |
| **Container Name** | room-24-hoppscotch |
| **Zweck** | API Development & Testing |
| **Framework** | [Hoppscotch](https://hoppscotch.io/) - Open Source API Platform |
| **Version** | hoppscotch/hoppscotch:latest |
| **Was kann der Container?** | • API request testing<br>• REST & GraphQL support<br>• Environment variables<br>• Request collections<br>• Team collaboration<br>• WebSocket testing<br>• Real-time API testing<br>• Offline capable |
| **Verbindungen** | → All APIs (Testing)<br>→ room-13-delqhi-api (Integration)<br>→ room-12-delqhi-rest (Integration) |
| **MCP Toolkit** | ❌ Nein |
| **Open Ports** | 3024:3000 |
| **Local Port** | 3024 (extern) → 3000 (intern) |
| **Status** | ✅ healthy |
...
## 🌐 DELQHI ECOSYSTEM (6 Container)

### 19. room-12-delqhi-db
| Attribut | Details |
|----------|---------|
| **Kategorie** | DELQHI (Infrastructure) |
| **Container Name** | room-12-delqhi-db |
| **Zweck** | Delqhi PostgreSQL Database |
| **Framework** | PostgreSQL 15 |
| **Version** | postgres:15-alpine |
| **Was kann der Container?** | • Delqhi platform data storage<br>• User management<br>• Social graph storage<br>• Content storage<br>• PostgreSQL native features |
| **Verbindungen** | ← room-12-delqhi-api (Primary DB)<br>← room-12-delqhi-rest (Read queries) |
| **MCP Toolkit** | ❌ Nein |
| **Open Ports** | 5412:5432 |
| **Local Port** | 5412 |
| **Status** | ✅ healthy |

---

### 20. room-12-delqhi-api
| Attribut | Details |
|----------|---------|
| **Kategorie** | DELQHI (API) |
| **Container Name** | room-12-delqhi-api |
| **Zweck** | Delqhi REST API Server |
| **Framework** | Node.js + Express |
| **Version** | Custom build |
| **Was kann der Container?** | • REST API endpoints<br>• User authentication<br>• Social features<br>• Content management<br>• API rate limiting |
| **Verbindungen** | → room-12-delqhi-db (Database)<br>→ room-04-redis-cache (Cache)<br>← room-12-delqhi-studio (Admin UI) |
| **MCP Toolkit** | ❌ Nein |
| **Open Ports** | 9999:9999 |
| **Local Port** | 9999 |
| **Status** | ✅ healthy |

---

### 21. room-12-delqhi-realtime
| Attribut | Details |
|----------|---------|
| **Kategorie** | DELQHI (Realtime) |
| **Container Name** | room-12-delqhi-realtime |
| **Zweck** | Real-time Updates & WebSockets |
| **Framework** | Node.js + Socket.io |
| **Version** | Custom build |
| **Was kann der Container?** | • WebSocket connections<br>• Real-time notifications<br>• Live updates<br>• Presence tracking<br>• Event broadcasting |
| **Verbindungen** | → room-04-redis-cache (Pub/Sub)<br>← All Delqhi services (Events) |
| **MCP Toolkit** | ❌ Nein |
| **Open Ports** | 4012:4000 |
| **Local Port** | 4012 |
| **Status** | ✅ running |

---

### 22. room-12-delqhi-rest
| Attribut | Details |
|----------|---------|
| **Kategorie** | DELQHI (REST) |
| **Container Name** | room-12-delqhi-rest |
| **Zweck** | RESTful API Gateway |
| **Framework** | Node.js |
| **Version** | Custom build |
| **Was kann der Container?** | • API gateway<br>• Request routing<br>• Load balancing<br>• API versioning<br>• Request/Response transformation |
| **Verbindungen** | → room-12-delqhi-api (Backend)<br>→ room-12-delqhi-db (Queries)<br>← External clients |
| **MCP Toolkit** | ❌ Nein |
| **Open Ports** | 3112:3000 |
| **Local Port** | 3112 |
| **Status** | ✅ running |

---

### 23. room-12-delqhi-storage
| Attribut | Details |
|----------|---------|
| **Kategorie** | DELQHI (Storage) |
| **Container Name** | room-12-delqhi-storage |
| **Zweck** | File Storage & CDN |
| **Framework** | MinIO or Custom |
| **Version** | Custom build |
| **Was kann der Container?** | • File upload/download<br>• S3-compatible API<br>• CDN functionality<br>• Image processing<br>• Storage management |
| **Verbindungen** | → room-12-delqhi-db (Metadata)<br>← All Delqhi services (File ops) |
| **MCP Toolkit** | ❌ Nein |
| **Open Ports** | 5012:5000 |
| **Local Port** | 5012 |
| **Status** | ✅ running |

---

### 24. room-12-delqhi-studio
| Attribut | Details |
|----------|---------|
| **Kategorie** | DELQHI (UI) |
| **Container Name** | room-12-delqhi-studio |
| **Zweck** | Delqhi Admin Studio |
| **Framework** | Next.js / React |
| **Version** | Custom build |
| **Was kann der Container?** | • Admin dashboard<br>• Content moderation<br>• User management<br>• Analytics<br>• System monitoring |
| **Verbindungen** | → room-12-delqhi-api (Management API)<br>→ room-12-delqhi-db (Analytics) |
| **MCP Toolkit** | ❌ Nein |
| **Open Ports** | 3012:3000 |
| **Local Port** | 3012 |
| **Status** | ⚠️ unhealthy |
...
│  │  └─ room-24-hoppscotch         [Hoppscotch]                      │   │
│  │                                                                     │   │
│  │  DELQHI:                                                            │   │
│  │  ├─ room-12-delqhi-db          [Database]                         │   │
│  │  ├─ room-12-delqhi-api         [API]                             │   │
│  │  ├─ room-12-delqhi-realtime    [Realtime]                       │   │
│  │  ├─ room-12-delqhi-rest        [REST Gateway]                   │   │
│  │  ├─ room-12-delqhi-storage     [Storage]                        │   │
│  │  └─ room-12-delqhi-studio      [Admin Studio]                  │   │
│  └─────────────────────────────────────────────────────────────────────┘   │
│                                                                              │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
### Agent-Nummerierung
**❌ Es gibt KEINEN agent-02!** Die Nummerierung ist kategorisch:
- **agent-01**: Orchestration (n8n)
- **agent-03**: Coding (Agent Zero)
- **agent-05**: Browser (Steel)
- **agent-06**: Visual AI (Skyvern)

### Plane.so (Nicht gestartet)
Room-11 (Plane.so) ist **nicht gestartet** weil es sehr ressourcenintensiv ist (10+ Container, 4-6GB RAM).
Soll bei Bedarf manuell gestartet werden.

### Delqhi Ecosystem
Alle 6 room-12-delqhi-* Container laufen und bilden ein komplettes Social Network.

---

**Document Version:** 2.0 - FINAL  
**Last Updated:** 2026-01-28 19:55 UTC  
**Generated By:** Sisyphus (Complete Infrastructure Analysis)  
**Next Update:** On major container changes
