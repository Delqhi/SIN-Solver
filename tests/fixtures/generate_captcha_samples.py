...
class CaptchaGenerator:
    ...
    def __init__(self, output_dir: str = "/Users/jeremy/dev/SIN-Solver/tests/fixtures/captchas"):
        ...
        self.types = [
            "text", "math", "image_grid", "recaptcha", "hcaptcha",
            "geetest", "funcaptcha", "turnstile", "keycaptcha",
            "capy", "pixcaptcha", "confident", "ador_captcha"
        ]
    ...
    def create_base_image(self, width: int = 200, height: int = 80, 
    ...
    def save_captcha(self, img: Image.Image, captcha_type: str, 
                     name: str, ground_truth: str):
