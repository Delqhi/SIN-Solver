...
class TwoCaptchaWorker:
    ...
    async def initialize(self) -> bool:
        ...
        try:
            ...
            self.browser = await playwright.chromium.connect_over_cdp(browser_ws_endpoint)
        ...
        try:
            ...
            for selector in captcha_selectors:
                ...
                if element:
                    ...
                    return CaptchaTask(task_id=task_id, captcha_type="image", image_data=image_data)
...
async def main():
    ...
    worker = TwoCaptchaWorker(username=username, password=password, headless=False)
