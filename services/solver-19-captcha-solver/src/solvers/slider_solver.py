...
class SliderSolver:
    ...
    def solve(
        self, slider_bytes: bytes, background_bytes: Optional[bytes] = None
    ) -> Dict[str, Any]:
        try:
            if background_bytes:
    ...
    def _solve_with_background(
        self, slider_bytes: bytes, background_bytes: bytes
    ) -> Dict[str, Any]:
        ...
        return {"offset": offset, "confidence": 0.9, "method": "slide_match"}
    ...
    def _solve_single_image(self, image_bytes: bytes) -> Dict[str, Any]:
        ...
        if alpha is not None:
            ...
            if len(non_transparent[1]) > 0:
                ...
                return {"offset": left_edge, "confidence": 0.85, "method": "alpha_detection"}
        ...
        return {"offset": offset, "confidence": 0.75, "method": "edge_detection"}

    def generate_slide_path(self, offset: int, duration_ms: int = 500) -> list:
        path = []
