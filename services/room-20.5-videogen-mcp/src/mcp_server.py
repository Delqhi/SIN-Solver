...
def add_text_overlay(
    ...
    args = ["-i", video_path, "-vf", filter_str, "-c:a", "copy", output_path]
...
def add_subtitles(
    ...
    args = [
        ...
        video_path,
        "-vf",
        f"subtitles={subtitle_file}:force_style='{style}'",
        "-c:a",
        "copy",
        output_path,
    ]
...
async def generate_tts_audio_async(
    text: str, output_path: str, voice: str = "en-US-GuyNeural", speed: float = 1.0
) -> tuple[bool, str]:
...
def resize_video(
    video_path: str, output_path: str, aspect_ratio: str = "16:9", resolution: Optional[str] = None
) -> tuple[bool, str]:
...
def merge_videos(
    video_paths: List[str], output_path: str, transition: str = "none"
) -> tuple[bool, str]:
...
def generate_thumbnail(
    video_path: str, output_path: str, time: float = 1.0, size: str = "1280x720"
) -> tuple[bool, str]:
...
def extract_audio(
    video_path: str, output_path: str, format: str = "mp3", bitrate: str = "192k"
) -> tuple[bool, str]:
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "scale": {
                        "type": "number",
                        "default": 0.15,
                        "description": "Logo scale relative to video width",
                    },
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "voice": {
                        ...
                        "description": "Voice: en, de, fr, es, it, pt, ja, ko, zh or full voice name",
                    },
        ...
        Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "duration": {
                        "type": "number",
                        "description": "Duration from start (alternative to end_time)",
                    },
                },
                "required": ["video_path"],
            },
            ...
            inputSchema={
                ...
                "properties": {
                    "video_paths": {
                        "type": "array",
                        "items": {"type": "string"},
                        "description": "List of video paths to merge",
                    },
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "time": {
                        "type": "number",
                        "default": 1.0,
                        "description": "Time in seconds to capture",
                    },
...
async def call_tool(name: str, arguments: dict) -> list[TextContent]:
    ...
    if name == "generate_video":
        ...
        if not success:
            return [
                TextContent(
                    type="text", text=json.dumps({"success": False, "error": f"TTS failed: {msg}"})
                )
            ]
        ...
        script = await generate_script_with_ai(
            topic=arguments["topic"], duration_seconds=arguments.get("duration_seconds", 60)
        )
