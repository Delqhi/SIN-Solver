...
class AntigravityAccount:
    ...
    def __init__(
        self, account_id: str, api_token: str, base_url: str = "https://api.antigravity.dev"
    ):
...
class AntigravityConnector:
    ...
    def _make_api_request(
        self, method: str, endpoint: str, account: Optional[AntigravityAccount] = None
    ...
    async def test_connection(self) -> Tuple[bool, str]:
        ...
        try:
            ...
            if response and response.status_code == 200:
                ...
                return (
                    False,
                    f"Connection failed with status: {response.status_code if response else 'No response'}",
                )
        except Exception as e:
