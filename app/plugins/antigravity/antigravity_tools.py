...
Examples:
  ...
  Test connection:
    python antigravity_tools.py test-connection
        ...
        add_parser.add_argument('--account-id', required=True, help='Unique identifier for the account')
        add_parser.add_argument('--api-token', required=True, help='API token for authentication')
        add_parser.add_argument('--base-url', default='https://api.antigravity.dev', help='Base URL for the API')
        
        # Remove account command
        remove_parser = subparsers.add_parser('remove-account', help='Remove an antigravity account')
        ...
        switch_parser = subparsers.add_parser('switch-account', help='Switch to a different account')
        switch_parser.add_argument('--account-id', required=True, help='Account ID to switch to')
        
        # Get current account command
        current_parser = subparsers.add_parser('get-current', help='Get information about the current account')
        
        # Test connection command
        test_parser = subparsers.add_parser('test-connection', help='Test connection to antigravity service')
    ...
    def _add_account(self, args):
        """Add a new account"""
        success = antigravity_connector.add_account(
            args.account_id,
            args.api_token,
            args.base_url
        )
