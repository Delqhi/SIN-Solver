...
CAPTCHA_TYPES_SEED = [
    ...
    # === HCAPTCHA FAMILY ===
    {
        "name": "hcaptcha_checkbox",
        "category": "behavioral",
        "provider": "hCaptcha",
        "difficulty": 4,
    },
    {
        "name": "hcaptcha_image_labeling",
        "category": "image",
        "provider": "hCaptcha",
        "difficulty": 6,
    },
    ...
    {
        "name": "turnstile_non_interactive",
        "category": "behavioral",
        "provider": "Cloudflare",
        "difficulty": 6,
    },
    {
        "name": "turnstile_invisible",
        "category": "behavioral",
        "provider": "Cloudflare",
        "difficulty": 8,
    },
    ...
    # === BEHAVIORAL CAPTCHAS ===
    {
        "name": "behavioral_mouse_movement",
        "category": "behavioral",
        "provider": "Generic",
        "difficulty": 6,
    },
    {
        "name": "behavioral_typing_pattern",
        "category": "behavioral",
        "provider": "Generic",
        "difficulty": 7,
    },
    {
        "name": "behavioral_click_pattern",
        "category": "behavioral",
        "provider": "Generic",
        "difficulty": 6,
    },
    ...
    # === CHINESE CAPTCHAS ===
    {
        "name": "chinese_character_recognition",
        "category": "text",
        "provider": "Generic",
        "difficulty": 8,
    },
    ...
    # === CUSTOM/RARE TYPES ===
    {
        "name": "gif_animation_recognition",
        "category": "image",
        "provider": "Generic",
        "difficulty": 8,
    },
    ...
    {
        "name": "canvas_fingerprint_challenge",
        "category": "behavioral",
        "provider": "Generic",
        "difficulty": 9,
    },
...
def seed_anti_detection_signatures(session):
    ...
    for sig_data in ANTI_DETECTION_SIGNATURES_SEED:
        existing = (
            session.query(AntiDetectionSignature)
            .filter_by(detection_type=sig_data["detection_type"])
            .first()
        )
        if not existing:
