...
class TrustScoreWarmer:
    ...
    GENERIC_SEARCH_TERMS = [
        "best pizza recipe", "weather tomorrow", "how to tie a tie",
        "current stock market", "funny cat videos", "top 10 movies 2026",
        "meaning of life", "python programming tutorial"
    ]
    ...
    async def _human_search(self, page: Page):
        ...
        search_input = await page.query_selector('input[type="text"], input[name="q"], input[name="search_query"]')
        if search_input:
