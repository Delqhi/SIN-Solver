...
class CapMonsterSolver:
    ...
    async def _get_result(self, task_id: str) -> Dict[str, Any]:
        ...
        async with httpx.AsyncClient(timeout=30.0) as client:
            response = await client.post(self.result_endpoint, json=payload, headers=headers)
    ...
    async def solve_image(
        self, image_base64: str, captcha_type: str = "auto"
    ) -> CapMonsterSolution:
        """
        ...
        try:
            ...
            if result["status"] == "ready":
                ...
                logger.info(
                    f"CapMonster solved image CAPTCHA in {time_ms}ms: '{solution}' (cost: ${cost})"
                )
    ...
    def _clean_solution(self, solution: str) -> str:
        ...
        prefixes_to_remove = ["Result:", "Answer:", "Solution:", "Text:", "Output:"]
    ...
    async def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "avg_cost_per_solve": round(
                self.stats["total_cost"] / max(1, self.stats["successes"]), 4
            ),
        }
    ...
    async def health_check(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "status": "healthy"
                if test_result.solution and not test_result.error
                else "unhealthy",
                "last_test": {
        ...
        try:
            ...
            async with httpx.AsyncClient(timeout=30.0) as client:
                response = await client.post(
                    "https://api.capmonster.cloud/getBalance", json=payload, headers=headers
                )
