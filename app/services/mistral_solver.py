...
class MistralSolver:
    ...
    def __init__(self, api_key: Optional[str] = None):
        ...
        self.api_key = api_key or settings.mistral_api_key if hasattr(settings, 'mistral_api_key') else None
        if not self.api_key:
        ...
        logger.info(f"Mistral solver initialized with API key: {'configured' if self.api_key else 'not configured'}")
    ...
    async def solve_image(self, image_base64: str, captcha_type: str = "auto", custom_prompt: Optional[str] = None) -> MistralSolution:
        """
        ...
        try:
            ...
            messages: List[Dict[str, Any]] = [
                {
                    ...
                    "content": [
                        ...
                        {
                            "type": "image_url",
                            "image_url": f"{image_prefix}{image_base64}"
                        }
                    ]
                }
            ]
            ...
            logger.info(f"Mistral solved CAPTCHA in {time_ms}ms: '{solution}' (confidence: {confidence})")
...
Return ONLY the solution, nothing else."""
    ...
    def _extract_solution(self, content: str, captcha_type: str) -> str:
        ...
        prefixes_to_remove = [
            "Text:", "Answer:", "Solution:", "The text is:", "The answer is:",
            "The solution is:", "Result:", "Output:", "The characters are:",
            "I see:", "The CAPTCHA shows:", "The image shows:"
        ]
