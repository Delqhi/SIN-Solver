...
class FunCaptchaSolver:
    ...
    async def solve_rotation(
        self, image_b64: str, instruction: str = "make the animal stand up"
    ) -> float:
        """
...
Gib NUR die Zahl zurück."""
        ...
        try:
            result = await self.vision_solver.vision_orchestrator.solve_visual_task(
                tmp_path, prompt
            )
