...
# Metrics, Analytics & Self-Improvement
# ==========================================

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
PROJECT_ROOT="$(dirname "$SCRIPT_DIR")"
SERVICE_NAME="zimmer-12-evolution-optimizer"
CONTAINER_NAME="Zimmer-12-Evolution-Optimizer"
IMAGE_NAME="sin-solver-zimmer-12-evolution-optimizer"
PORT_EXTERNAL=8007
PORT_INTERNAL=8080
...
case "${1:-help}" in
    ...
    build)   build_image "./services/zimmer-12-evolution" ;;
